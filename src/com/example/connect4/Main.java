...
public class Main extends Application {
	...
	private void aboutMe() {
		...
		alert.setHeaderText("Aasritha Sai");
		alert.setContentText("I love to play around with code and create games.Connect4 is one of them.In free time,I like to spend time with my near and dears.");
		alert.show();
	}
